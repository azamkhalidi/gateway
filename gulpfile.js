...
gulp.task('less', function () {
	  gulp.src(config.app + 'content/less/main.less')
	    .pipe(less())
...
gulp.task('inject:less', ['less', 'inject:css']);
...
gulp.task('inject:css', function() {
	return gulp.src(config.app + 'index.html')
		.pipe(inject(gulp.src(config.app + 'content/css/main.css', {read : false}), {
				starttag : '<!-- less:css -->',
				endtag : '<!-- endinject -->',
				name : 'less',
				relative : true
...
gulp.task('assets:prod', ['images', 'html'], build);
...
gulp.task('watch', function () {
    ...
    gulp.watch(config.app + 'content/less/**/*.less', ['inject:less']);
...
gulp.task('install', function () {
    runSequence(['inject:dep', 'ngconstant:dev'], 'inject:app', 'inject:less', 'inject:troubleshoot');
});
...
gulp.task('build', ['clean'], function (cb) {
    runSequence(['copy', 'inject:vendor', 'ngconstant:prod'], 'inject:app', 'inject:less', 'inject:troubleshoot', 'assets:prod', cb);
});
